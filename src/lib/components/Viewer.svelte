<script lang="ts">
  import ViewerDetails from "./viewer/ViewerDetails.svelte";
  import ViewerHeader from "./viewer/ViewerHeader.svelte";
  import ViewerStage from "./viewer/ViewerStage.svelte";
  import type { Mode } from "./viewer/modes";
  import { FULL_PREVIEW_EDGE, buildPreview } from "$lib/api";
  import { session } from "$lib/session.svelte";
  import { ZoomPan } from "$lib/zoom.svelte";
