 ...
 * two ways of handing a path to the file manager. They live here for the
 * reason `invoke` lives in [api.ts](src/lib/api.ts) — one place per outside
 * surface — and because each of them fails the same way, by leaving a
