<script lang="ts">
  ...
  const paths = {
    ...
    more: "M13 5a1 1 0 1 0-2 0 1 1 0 0 0 2 0M13 12a1 1 0 1 0-2 0 1 1 0 0 0 2 0M13 19a1 1 0 1 0-2 0 1 1 0 0 0 2 0",
    settings:
    ...
    minus: "M5 12h14",
    reload:
      "M21 12a9 9 0 1 1-9-9c2.52 0 4.93 1.06 6.74 2.74L21 8M21 3v5h-5",
    fit: "M8 3H5a2 2 0 0 0-2 2v3M21 8V5a2 2 0 0 0-2-2h-3M3 16v3a2 2 0 0 0 2 2h3M16 21h3a2 2 0 0 0 2-2v-3",
    compare: "M12 3v18M7 8 3 12l4 4M17 8l4 4-4 4",
